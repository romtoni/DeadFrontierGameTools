	...
	if (profession != profession_old) 
	{
		...
		switch(profession)
		{
			...
			case "soldier" : bonus_strength = 5;
							...
							bonus_explosive = 0;
							break;
			case "policeofficer" : bonus_strength = 0;
							bonus_endurance = 0;
							bonus_agility = 0;
							bonus_accuracy = 10;
							bonus_critical_hit = 0;
