function check_route(route_param)
{
	...
	switch(route)
	{
		case "nh_to_ds" : total_blocks = 20; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "nh_to_p13" : total_blocks = 31; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "nh_to_fp" : total_blocks = 32; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "nh_to_sb" : total_blocks = 68; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "ds_to_nh" : total_blocks = 20; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "ds_to_p13" : total_blocks = 40; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber";  break;
		case "ds_to_fp" : total_blocks = 41; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "ds_to_sb" : total_blocks = 71; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "p13_to_nh" : total_blocks = 75; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "p13_to_ds" : total_blocks = 40; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "p13_to_fp" : total_blocks = 33; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "p13_to_sb" : total_blocks = 75; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "fp_to_nh" : total_blocks = 32; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "fp_to_ds" : total_blocks = 41; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "fp_to_p13" : total_blocks = 33; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "fp_to_sb" : total_blocks = 41; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "sb_to_nh" : total_blocks = 68; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "sb_to_ds" : total_blocks = 71; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "sb_to_p13" : total_blocks = 75; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "sb_to_fp" : total_blocks = 41; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
		case "others" : total_blocks = 0; document.getElementById("total_blocks").readOnly = false; document.getElementById("total_blocks").className = "inputnumber_editable"; break;
		default : total_blocks = 0; document.getElementById("total_blocks").readOnly = true; document.getElementById("total_blocks").className = "inputnumber"; break;
	}
