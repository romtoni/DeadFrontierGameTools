function check_looting_type(looting_type_param, looting_zone_param)
{
	...
	if (looting_type == 'boss_hunt')
	{
		...
		switch (looting_zone)
		{
			case "blue_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='flamingzombie'>Flaming Zombie</option></select>";
													break;
			case "green_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='flamingzombie'>Flaming Zombie</option><option value='mother'>Mother</option><option value='titan'>Titan</option></select>";
													break;
			case "yellow_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='flamingzombie'>Flaming Zombie</option><option value='mother'>Mother</option><option value='giantspider'>Giant Spider</option><option value='titan'>Titan</option><option value='wraith'>Wraith</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option></select>";
													break;										
			case "orange_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='mother'>Mother</option><option value='giantspider'>Giant Spider</option><option value='titan'>Titan</option><option value='wraith'>Wraith</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option></select>";
													break;											
			case "red_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value))'><option value=''>--No Boss--</option><option value='mother'>Mother</option><option value='giantspider'>Giant Spider</option><option value='titan'>Titan</option><option value='wraith'>Wraith</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option></select>";
													break;	
			case "black_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='mother'>Mother</option><option value='giantspider'>Giant Spider</option><option value='titan'>Titan</option><option value='wraith'>Wraith</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option></select>";
													break;	
			case "white_zone" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='flaminglongarm'>Flaming Long Arm</option><option value='flamingrumbler'>Flaming Rumbler</option><option value='flamingfleshhound'>Flaming Flesh Hound</option><option value='flamingmother'>Flaming Mother</option><option value='flamingtitan'>Flaming Titan</option><option value='flamingwraith'>Flaming Wraith</option><option value='flaminggiantspider'>Flaming Giant Spider</option><option value='blacktitan'>Black Titan</option><option value='flamingblacktitan'>Flaming Black Titan</option></select>";
													break;
			case "wasteland" : zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value, looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option><option value='devilhound'>Devil Hound</option></select>";
													break;										
													
			default : 	zombie_boss_name = "<select name='zombie_boss_name' id='zombie_boss_name' onchange='get_max_loot_spot(zombie_boss_name.value,looting_zone.value, looting_type.value)'><option value=''>--No Boss--</option></select>";
											break;	
		}
	}
...
function get_max_loot_spot(zombie_boss_name_param, looting_zone_param,  looting_type_param)
{
	...
	if (looting_type == 'boss_hunt')
	{
		switch(looting_zone)
		{
			case "blue_zone" : max_loot_spot = 1; break;
			case "green_zone" : max_loot_spot = 1; break;
			case "yellow_zone" : max_loot_spot = 1; break;										
			case "orange_zone" : max_loot_spot = 1; break;											
			case "red_zone" : max_loot_spot = 1; break;	
			case "black_zone" : if (zombie_boss_name=='flamingblacktitan' || zombie_boss_name=='blacktitan') max_loot_spot = 1; 
								...
								break;	
			case "white_zone" : if (zombie_boss_name=='flamingblacktitan' || zombie_boss_name=='blacktitan') max_loot_spot = 1; 
								else if (zombie_boss_name=='flaminglongarm' || zombie_boss_name=='flamingrumbler' || zombie_boss_name=='flamingfleshhound') max_loot_spot = 5; 
								else max_loot_spot = 2; 
								break;	
			case "wasteland" : max_loot_spot = 1; break;									
														
			default : max_loot_spot = 0; break;	 
		}
		document.getElementById('max_loot_spot').value = max_loot_spot;
	}
	else if (looting_type == 'inner_city')
